...
@on_command('music_recommend', aliases=('推荐音乐', '音乐推荐', '推荐首', '推荐一首', '推薦音樂', '音樂推薦', '推薦首', '推薦一首'))
async def music_recommend(session: CommandSession):
    ...
    if music_report:
        ...
        logger.error("Not found musicInfo")
...
@on_natural_language(keywords={'推荐一首', '推荐首', '推薦一首', '推薦首'})
